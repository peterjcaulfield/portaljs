;(function(window, document, undefined) {
    ...
    Portal.prototype = {
        ...
        */
        _bytesToHumanReadable: function(numBytes) {
        ...
        * @return {object} 
        */
        _createRequestData: function(file) {
        ...
        */
        _bindOnLoadEvent: function(request) {
        ...
        * @return {function} - function to executed on xhr request onload event
        */
        _bindOnTimeOutEvent: function(request) {
        ...
        */
        _bindOnProgressEvent: function(request) {
        ...
        */
        _createRequestObject: function(file) {
        ...
        * @return {boolean}
        */
        _isValidFilesize: function(filesize) {
        ...
        * @return {boolean}
        */
        _isValidFiletype: function(filename) {
        ...
        * @return {boolean}
        */
        _isHiddenFiletype: function(filename) {
            return filename[0] == '.';
        },
        ...
        */
        _initialise: function(defaults, options) {
        ...
        */
        _updateConfig: function(defaults, options) {
        ...
        */
        _triggerClickEvent: function(elementId) {
        ...
        */
        _createHiddenPortal: function(id) {
